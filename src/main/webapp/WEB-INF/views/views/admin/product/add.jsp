...
<%@ include file="/WEB-INF/views/components/taglib.jsp" %>   
		  <div class="col-md-10">
			  <form id="formProduct" action="${urlAdminProduct}/them-san-pham.html" method="post" enctype="multipart/form-data">
	  			  <div class="row">
				  			...
				  			<div>
								...
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label for="file">Hình ảnh chính</label>
											<form:errors path="productError.picture" cssClass="err"/>
											<input type="file" name="mainImage" >
											<p class="help-block"><em>Định dạng: jpg, png, jpeg, gif</em></p>
										</div>
										<div class="form-group">
											<label for="file">Hình ảnh phụ</label>
