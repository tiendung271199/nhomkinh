...
<%@ include file="/WEB-INF/views/components/taglib.jsp" %>
	<div class="col-md-10 panel-info">
		...
		<div class="content-box-large box-with-header">
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<input type="file" name="image" class="btn btn-default" multiple="multiple" >
			...
			<hr >
			<c:if test="${not empty pictureList or not empty product.picture}">
				...
				<table class="table table-striped table-bordered" id="example">
					...
					<tbody>
						...
						<tr class="odd gradeA">
							<td>${stt = stt + 1}</td>
							<td>
								<img width="200px" height="120px" src="${pictureContextPath}/product/image/${product.picture}" />
							</td>
							<td align="center">
								<button class="btn btn-success">Hiện tại</button>
								<!-- <input type="checkbox" name="main" checked="checked" readonly="readonly" /> -->
							</td>
						...
						<c:forEach items="${pictureList}" var="picture" >
							<tr class="odd gradeA">
								...
								<td align="center">
									<a href="${urlAdminProduct}/cap-nhat-hinh-anh-san-pham-${product.id}/hinh-anh-${picture.id}.html" title="Đặt làm hình ảnh chính" class="btn btn-primary">Sử dụng</a>
								</td>
...
<script type="text/javascript">
	...
	function updatePicture(productId, pictureId) {
		$.ajax({
			url: '${urlAdminProduct}/cap-nhat-hinh-anh-san-pham',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: {
