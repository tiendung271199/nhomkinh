...
public class ProductValidate implements Validator {
	...
	public boolean validatePicture(Errors errors, MultipartFile multipartFile) {
	...
	public boolean validateListPicture(Model model, List<MultipartFile> multipartFileList) {
